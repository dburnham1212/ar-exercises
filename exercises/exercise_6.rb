...
@store2.employees.create(first_name: "Minnie", last_name: "Mouse", hourly_rate: 55)
@store2.employees.create(first_name: "Bugs", last_name: "Bunny", hourly_rate: 55)
@store2.employees.create(first_name: "Lola", last_name: "Bunny", hourly_rate: 40)
